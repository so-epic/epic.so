...
const TravisGiggy = () => {
  return (
    ...
    // <div id="travis" class="flex flex-col md:flex-row lg:flex-row md:justify-center h-full mt-4 mb-32">

    //   <div class="md:flex md:flex-col md:self-start md:-mt-8 lg:ml-40">
    //     <img class="object-contain -ml-24 md:-ml-24 inset-16 md:w-56" src={CurvedLines} alt="" />
    ...
    //       <span class="text-nameSecondaryColor">Giggy</span>
    //     </h1>
    //     <p class="font-beBetter ml-8 md:ml-64 max-w-lg font-regular text-descriptionSize text-personDescriptionColor tracking-widest leading-7 mt-4 breaking-normal">
    //       Travis Giggy is a serial enterpreneur in
    //       Silicon Valley with more than 20 years
    //       leading product and technology teams.
    //       He is a technology expert, angel investor,
