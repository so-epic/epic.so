...
const ContactModal = (props) => {
  ...
  return (
    <div {...props.contactMorph}  class="z-50 modal fixed w-full h-full top-0 left-0 flex items-center justify-center">
      <div {...props.contactMorph}  class="modal-overlay fixed w-full h-full bg-white opacity-75 top-0 left-0 cursor-pointer z-50"></div>
      <div {...props.contactMorph}  class="modal-contact-div fixed flex-col top-0 ml-0 md:ml-64 mt-32 z-75">
