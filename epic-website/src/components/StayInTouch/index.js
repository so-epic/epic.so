...
function StayInTouch() {
  return(
    <div class="flex flex-col items-center container h-full mt-32 space-y-16">
      ...
      <div class="flex flex-col h-70 w-112 items-center bg-stayInTouchBlue rounded-lg">
      ...
      <div class="flex flex-col h-70 w-112 items-center bg-white border-2 border-epicBlue rounded-lg">
